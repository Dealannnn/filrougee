      ...
      <div className="container marketing">
        <div className="row">
          <div className="col-lg-4">
            <img src="/images/carousel1.webp" className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Produit 1" />
            <h2 className="fw-normal">Produit 1</h2>
            <p>Parfait pour votre quotidien.</p>
            <p><a className="btn btn-secondary" href="#">Voir détails »</a></p>
          </div>
          <div className="col-lg-4">
            <img src="/images/carousel2.jpeg" className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Produit 2" />
            <h2 className="fw-normal">Produit 2</h2>
            <p>Technologie à petit prix.</p>
            <p><a className="btn btn-secondary" href="#">Voir détails »</a></p>
          </div>
          <div className="col-lg-4">
            <img src="/images/carousel1.webp" className="bd-placeholder-img rounded-circle" width="140" height="140" alt="Produit 3" />
            <h2 className="fw-normal">Produit 3</h2>
            <p>Qualité et fiabilité garanties.</p>
            <p><a className="btn btn-secondary" href="#">Voir détails »</a></p>
          </div>
        </div>
      </div>
